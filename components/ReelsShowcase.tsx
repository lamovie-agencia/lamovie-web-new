  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 left-4 right-4 sm:bottom-5 sm:left-5 sm:right-5">
        <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-movie-red flex items-center justify-center mb-3 sm:mb-4 shadow-[0_0_24px_rgba(176,35,46,0.5)]">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-x-3 gap-y-1 text-[10px] font-black uppercase tracking-widest text-white/70">
...
export default function ReelsShowcase() {
  ...
  return (
    <section className="relative z-20 py-16 sm:py-20 overflow-hidden bg-[#050505] border-y border-white/5">
      <div className="container mx-auto px-4 sm:px-6 mb-8 sm:mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="min-w-0">
          <p className="text-movie-red text-[10px] sm:text-xs uppercase tracking-[0.28em] sm:tracking-[0.35em] font-black mb-3">Impacto vertical</p>
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-heading font-black uppercase tracking-tight md:tracking-tighter leading-[0.95] text-balance">Reels que detienen el scroll</h2>
        </div>
      ...
      <div className="w-full overflow-x-auto overscroll-x-contain no-scrollbar px-4 sm:px-6 pb-4 snap-x snap-mandatory">
        <div className="mx-auto flex w-max min-w-full max-w-none justify-start gap-4 sm:gap-5 md:justify-center">
          {visible.map((reel) => (
        ...
        {selected && (
          ...
          >
            <button
              ...
              className="absolute top-4 right-4 sm:top-5 sm:right-5 w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white z-20"
            ...
            <motion.div
              ...
              className="relative aspect-[9/16] h-[78svh] max-h-[760px] max-w-[94vw] overflow-hidden rounded-[24px] border border-white/10 bg-neutral-950 shadow-2xl sm:h-[88vh] sm:rounded-[32px]"
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 bg-gradient-to-t from-black/90 to-transparent pointer-events-none">
                <h3 className="text-lg sm:text-xl font-black uppercase leading-tight">{selected.title}</h3>
