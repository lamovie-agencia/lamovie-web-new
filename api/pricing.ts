  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      const result = await db.query(
        `INSERT INTO pricing_packages (name, category, price, period, description, features, recommended, color, icon)
         VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
         RETURNING *`,
        [name, category || 'social', String(price || '0'), period || '', description || '', asArray(features), Boolean(recommended), color || '', icon || '']
      );
